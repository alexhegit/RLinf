   ...
   <div style="display: flex; justify-content: center; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
     <div style="flex: 1 1 30%; max-width: 300px; text-align: center;">
       <img src="https://github.com/RLinf/misc/raw/main/pic/3_layer_mlp.jpg"
            style="width: 100%; height: 200px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.15);" />
       <p style="margin-top: 8px; font-size: 14px; line-height: 1.4;">
         <a href="rocm_maniskill_sac_mlp.html" style="text-decoration: underline; color: blue;">
           <b>ROCm Tutorial for ManiSkill SAC-MLP</b>
         </a><br>
         Run the ManiSkill SAC-MLP example on AMD GPUs with a ROCm-specific CPU-physics override
       </p>
     </div>
